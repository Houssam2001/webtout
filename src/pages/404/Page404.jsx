...
const Page404 = () => {
  return(
      <section className="p-0 bg-img cover-background" style={{backgroundImage: 'url(' + "https://www.bootdey.com/img/Content/bg1.jpg" + ')' }}>
          ...
          <div className="row align-items-center justify-content-center min-vh-100">
              <div className="col-md-9 col-lg-6 my-5">
                  <div className="text-center error-page">
                      ...
                      <p className="w-sm-80 mx-auto mb-4 text-white">This page is incidentally inaccessible because of
