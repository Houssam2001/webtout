...
import {TablePluginRef} from "../../components/Table1/consts";
import addTablePlugin from '../../components/Table1';
import {ChartPluginRef} from "../../components/Chart/consts";
import addChartPlugin from '../../components/Chart';
import './style.css'
const Editor = () => {
    let statusCards = [
        {
    ...
    useEffect(() => {
        if (!pluginLoaded) {
            ...
            e.addComponents(`<body>
  <header class="header-banner">
    <div class="container-width">
      <div class="logo-container">
        <div class="logo">WebTout
        </div>
      </div>
      <nav class="menu">
